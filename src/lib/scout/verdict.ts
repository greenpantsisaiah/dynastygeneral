...
function buildUserMessage(args: {
  ...
  const teamSummaries = ranked.map((t, i) => ({
    ...
    // Canonical FormatRules from llm-contract.ts. Includes
    // qb_starters_max, te_premium, second_qb_starts, sf_eligible,
    // etc. Per cross-endpoint LLM-contract pillar in INVARIANTS.md.
