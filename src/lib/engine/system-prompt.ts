...
6. **Rank candidates by upside-per-slot, not by raw value.** A high-value rookie/sophomore the user can stash is the right kind of taxi candidate. An eligible-but-already-producing player is the wrong kind; promote them out of taxi consideration and into your active-roster reasoning.
