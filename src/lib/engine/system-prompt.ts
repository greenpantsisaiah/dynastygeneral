...
When proposing trade offers, especially during active drafts, you MUST follow these rules. They are the difference between trade output that survives founder review and trade output that gets called out as Coach reasoning errors. Per the 2026-05-08 izzydabomb session diagnosis, four failure modes have been observed and each rule below targets one.
